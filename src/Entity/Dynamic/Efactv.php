...
use App\Repository\EfactvRepository;
use Doctrine\DBAL\Types\Types;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: EfactvRepository::class)]
class Efactv
{
    #[ORM\Id]
    ...
    public function getTimbref()
    {
        return $this->timbref;
    }

    public function setTimbref($timbref)
    {
        $this->timbref = $timbref;
